...
import com.foxtv.app.ui.screens.account.InputField
...
fun DebugSettingsContent(
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        LazyColumn(
            ...
            contentPadding = PaddingValues(top = FoxTvTheme.spacing.md, bottom = FoxTvTheme.spacing.xxl),
            ...
            item(key = "debug_popup_header") {
                Text(
                    ...
                    modifier = Modifier.padding(bottom = FoxTvTheme.spacing.xs)
                )
            }
    ...
    Card(
        ...
        Column(
            ...
            Row(
                ...
                DebugProgressIndicatorPreview(stringResource(R.string.debug_progress_indicator_default), FoxTvTheme.spacing.xxxl)
...
private fun DebugDialogButton(
    ...
    Card(
        ...
        shape = CardDefaults.shape(RoundedCornerShape(FoxTvTheme.radii.sm)),
        scale = CardDefaults.scale(focusedScale = 1.0f)
    ) {
        Text(
            text = text,
            style = MaterialTheme.typography.bodyMedium,
            color = if (isFocused) FoxTvTheme.colors.TextPrimary else FoxTvTheme.colors.TextSecondary,
            modifier = Modifier
                .fillMaxWidth()
                .padding(vertical = FoxTvTheme.spacing.md, horizontal = FoxTvTheme.spacing.lg),
    ...
    Column(
        ...
        if (result != null) {
            Text(
                text = result,
                style = MaterialTheme.typography.bodySmall,
                color = if (result.startsWith("Failed")) FoxTvTheme.colors.Error else FoxTvTheme.colors.Secondary
            )
        }
