...
fun AddonManagerScreen(
    ...
    val manageFromPhoneSubtitle = if (webConfigMode == com.foxtv.app.core.server.AddonWebConfigMode.COLLECTIONS_ONLY) {
    ...
    val qrInstruction = if (webConfigMode == com.foxtv.app.core.server.AddonWebConfigMode.COLLECTIONS_ONLY) {
                ...
                item {
                    Card(
                        ...
                        Text(
                            ...
                            modifier = androidx.compose.ui.Modifier.padding(FoxTvTheme.spacing.lg)
                        )
                    }
                }
            }
            ...
            item {
                Row(
                    ...
                    if (uiState.isLoading && uiState.installedAddons.isEmpty()) {
                        LoadingIndicator(modifier = Modifier.height(FoxTvTheme.spacing.xl))
                    }
                }
            }
