...
import com.foxtv.app.ui.components.CollectionRowSection
import com.foxtv.app.ui.components.ContinueWatchingSection
import com.foxtv.app.domain.model.ContinueWatchingCardStyle
import com.foxtv.app.ui.components.HeroCarousel
import com.foxtv.app.ui.components.HeroCarouselBackdrop
...
fun ClassicHomeContent(
    ...
    LazyColumn(
        ...
        contentPadding = PaddingValues(top = if (heroVisible) FoxTvTheme.spacing.none else FoxTvTheme.spacing.xl, bottom = FoxTvTheme.spacing.xl),
