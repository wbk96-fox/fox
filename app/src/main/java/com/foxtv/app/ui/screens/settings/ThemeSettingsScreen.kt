...
import com.foxtv.app.ui.theme.getFontFamily
...
fun ThemeSettingsContent(
    ...
    val appliedSettingsUiStyle = FoxTvTheme.settingsUiStyle
    LaunchedEffect(Unit) {
            ...
            SettingsGroupCard(
                ...
                Row(
                    modifier = Modifier
                        ...
                        .padding(horizontal = FoxTvTheme.spacing.xs, vertical = FoxTvTheme.spacing.xs)
...
private fun ThemeSwatchChip(
    ...
    Card(
        ...
        Column(
            modifier = Modifier
                .fillMaxWidth()
                .padding(horizontal = FoxTvTheme.spacing.sm, vertical = FoxTvTheme.spacing.md),
