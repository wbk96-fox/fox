...
import com.foxtv.app.LocalContentFocusRequester
...
import com.foxtv.app.ui.components.GridContinueWatchingSection
import com.foxtv.app.domain.model.ContinueWatchingCardStyle
import com.foxtv.app.ui.components.HeroCarousel
import com.foxtv.app.ui.components.PosterCardDefaults
import com.foxtv.app.ui.components.PosterCardStyle
import com.foxtv.app.ui.components.collectionFolderCardImageUrl
...
fun GridHomeContent(
    ...
    onItemFocus: (com.foxtv.app.domain.model.MetaPreview) -> Unit = {},
    ...
    val topPadding = if (hasHero) FoxTvTheme.spacing.none else FoxTvTheme.spacing.xl
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        val horizontalPadding = FoxTvTheme.spacing.xxxl + FoxTvTheme.spacing.xl
        val spacing = FoxTvTheme.spacing.md
...
private fun SectionDivider(
    ...
    Box(
        modifier = modifier
            .fillMaxWidth()
            .padding(top = FoxTvTheme.spacing.xl, bottom = FoxTvTheme.spacing.md)
    ) {
        Text(
            text = catalogName,
...
private fun StickyCategoryHeader(
    ...
    Box(
        modifier = modifier
            ...
            .padding(horizontal = FoxTvTheme.spacing.xxxl, vertical = FoxTvTheme.spacing.md)
    ) {
        Text(
            text = sectionName,
