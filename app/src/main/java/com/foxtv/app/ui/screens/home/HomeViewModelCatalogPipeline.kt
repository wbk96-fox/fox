...
private data class CatalogUpdateResult(
    ...
    val heroItems: List<com.foxtv.app.domain.model.MetaPreview>,
                        ...
                        if (currentLayout == HomeLayout.MODERN) {
                            ...
                            val fakeItems = (0 until 8).map { i ->
                                MetaPreview(
                                    ...
                                    type = com.foxtv.app.domain.model.ContentType.fromString(placeholder.apiType),
...
internal fun HomeViewModel.mergeRefreshedCatalogRow(
    ...
    val identity = { item: com.foxtv.app.domain.model.MetaPreview -> item.apiType + ":" + item.id }
