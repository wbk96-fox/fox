        ...
        Column(
            ...
            Card(
                ...
                colors = CardDefaults.colors(
                    containerColor = if (selected.isEmpty()) FoxTvTheme.colors.FocusBackground else FoxTvTheme.colors.BackgroundCard,
                ...
                Row(
                    ...
                    Text(
                        text = allLabel,
                        color = if (selected.isEmpty()) FoxTvTheme.colors.Primary else FoxTvTheme.colors.TextPrimary,
                ...
                Card(
                    ...
                    Box(modifier = Modifier.padding(horizontal = 14.dp, vertical = FoxTvTheme.spacing.md)) {
                        BasicTextField(
                            ...
                            cursorBrush = SolidColor(if (isInputFocused) FoxTvTheme.colors.Primary else Color.Transparent),
