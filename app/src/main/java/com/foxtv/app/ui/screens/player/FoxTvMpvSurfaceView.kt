...
class FoxTvMpvSurfaceView @JvmOverloads constructor(
    context: Context,
            ...
            when (type) {
                "audio" -> {
                    audioTracks += MpvTrack(
                        id = id,
                        type = type,
                        name = title ?: language ?: context.getString(com.foxtv.app.R.string.player_track_audio_fallback, id),
                        language = language,
                        codec = codec,
                ...
                "sub" -> {
                    subtitleTracks += MpvTrack(
                        id = id,
                        type = type,
                        name = title ?: language ?: context.getString(com.foxtv.app.R.string.player_track_subtitle_fallback, id),
                        language = language,
                        codec = codec,
                        channelCount = null,
                        isSelected = selected,
    ...
    companion object {
        private const val TAG = "FoxTvMpvSurfaceView"
