...
import com.foxtv.app.ui.components.CatalogRowSection
...
import com.foxtv.app.ui.screens.home.ClassicHomeContent
import com.foxtv.app.ui.screens.home.ContinueWatchingItem
import com.foxtv.app.ui.screens.home.GridHomeContent
import com.foxtv.app.ui.screens.home.HeroBackdropState
import com.foxtv.app.ui.screens.home.HomeScreenFocusState
import com.foxtv.app.ui.screens.home.key
import com.foxtv.app.domain.model.MetaPreview
import com.foxtv.app.ui.screens.home.ModernHomeContent
...
fun FolderDetailScreen(
    ...
    if (folder == null) {
        Box(modifier = Modifier.fillMaxSize(), contentAlignment = Alignment.Center) {
            Text(stringResource(R.string.folder_detail_not_found), color = FoxTvTheme.colors.TextSecondary)
        }
        return
    }

    val isItemWatched: (MetaPreview) -> Boolean = remember(uiState.movieWatchedStatus) {
        { item -> uiState.movieWatchedStatus[com.foxtv.app.ui.screens.home.homeItemStatusKey(item.id, item.apiType)] == true }
    }
...
@Composable
private fun FolderHeader(folder: com.foxtv.app.domain.model.CollectionFolder) {
    Row(
        modifier = Modifier
            .fillMaxWidth()
            .padding(horizontal = FoxTvTheme.spacing.xxxl, vertical = FoxTvTheme.spacing.sm),
        ...
        if (!folder.coverImageUrl.isNullOrBlank()) {
            ...
            when (folder.tileShape) {
                com.foxtv.app.domain.model.PosterShape.POSTER -> { iconWidth = FoxTvTheme.spacing.xxl; iconHeight = FoxTvTheme.spacing.xxxl }
                com.foxtv.app.domain.model.PosterShape.LANDSCAPE -> { iconWidth = 64.dp; iconHeight = 36.dp }
                com.foxtv.app.domain.model.PosterShape.SQUARE -> { iconWidth = FoxTvTheme.spacing.xxxl; iconHeight = FoxTvTheme.spacing.xxxl }
            }
            AsyncImage(
...
private fun TabbedGridContent(
    ...
    folder: com.foxtv.app.domain.model.CollectionFolder,
    ...
    Row(
        modifier = Modifier
            .fillMaxWidth()
            .padding(start = FoxTvTheme.spacing.xxxl, end = FoxTvTheme.spacing.xxxl, top = FoxTvTheme.spacing.sm, bottom = FoxTvTheme.spacing.sm),
        verticalAlignment = Alignment.CenterVertically,
        ...
        currentTab.catalogRow != null -> {
            ...
            LazyVerticalGrid(
                ...
                contentPadding = PaddingValues(
                    ...
                    end = FoxTvTheme.spacing.xxxl,
                    top = FoxTvTheme.spacing.lg,
                    bottom = FoxTvTheme.spacing.xxxl
                ),
                horizontalArrangement = Arrangement.spacedBy(FoxTvTheme.spacing.lg),
...
private fun RowsContent(
    ...
    LazyColumn(
        ...
        contentPadding = PaddingValues(top = FoxTvTheme.spacing.lg, bottom = FoxTvTheme.spacing.xxxl),
        verticalArrangement = Arrangement.spacedBy(FoxTvTheme.spacing.xxl)
    ) {
                    ...
                    tab.isLoading -> {
                        Column(modifier = Modifier.fillMaxWidth()) {
                            Text(
                                ...
                                color = FoxTvTheme.colors.TextPrimary,
                                modifier = Modifier.padding(start = FoxTvTheme.spacing.xxxl, end = FoxTvTheme.spacing.xxxl, bottom = FoxTvTheme.spacing.md)
                            )
                            Box(
                                modifier = Modifier
                                    .fillMaxWidth()
                    ...
                    tab.error != null -> {
                        Column(modifier = Modifier.fillMaxWidth()) {
                            ...
                            Box(
                                ...
                                Text(text = tab.error, color = FoxTvTheme.colors.TextSecondary)
                            }
                        }
                    }
                    catalogRow != null -> {
...
private fun FollowLayoutContent(
    ...
    val isItemWatched: (MetaPreview) -> Boolean = remember(homeState.movieWatchedStatus) {
        { item -> homeState.movieWatchedStatus[com.foxtv.app.ui.screens.home.homeItemStatusKey(item.id, item.apiType)] == true }
    }
    val loadMoreLabel = stringResource(R.string.action_load_more)
