...
import com.foxtv.app.core.debrid.DebridProviderAuthMethod
...
private fun DebridSectionLabel(text: String) {
    Text(
        ...
        modifier = Modifier.padding(start = FoxTvTheme.spacing.sm, top = FoxTvTheme.spacing.sm)
    )
}
            ...
            Box(modifier = Modifier.padding(horizontal = 14.dp, vertical = FoxTvTheme.spacing.md)) {
                BasicTextField(
                    ...
                    cursorBrush = SolidColor(
                        if (isInputFocused) FoxTvTheme.colors.Primary else Color.Transparent
                    ),
