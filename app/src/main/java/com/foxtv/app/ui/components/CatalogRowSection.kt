...
import com.foxtv.app.domain.model.stableItemKey
import com.foxtv.app.domain.model.stableItemKeys
        ...
        Row(
            ...
            Column(verticalArrangement = Arrangement.spacedBy(FoxTvTheme.spacing.xs)) {
                Text(
                    ...
                    color = if (catalogTitle.isBlank()) Color.Transparent else FoxTvTheme.colors.TextPrimary,
                    maxLines = 3,
                ...
                if (showAddonName) {
                    Text(
                        ...
                        color = if (catalogTitle.isBlank()) Color.Transparent else FoxTvTheme.colors.TextTertiary
                    )
                }
            }
        }
