...
import com.foxtv.app.data.remote.supabase.SupabaseWatchProgress
import com.foxtv.app.data.remote.supabase.SupabaseWatchProgressEvent
...
class WatchProgressSyncService @Inject constructor(
     ...
     * Always syncs regardless of CW source — both Trakt and FoxTv Sync
