package com.foxtv.app.core.diagnostics
...
object SentryInitializer {
    ...
    private fun applyEnabled(application: Application, enabled: Boolean) {
        ...
        Sentry.configureScope { scope ->
            ...
            // FOX.TV ships one full distribution, so there is no product flavour to
            // report; the build type alone identifies the artifact.
