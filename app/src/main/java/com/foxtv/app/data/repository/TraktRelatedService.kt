...
import com.foxtv.app.core.trakt.traktBestLandscapeUrl
    ...
    suspend fun getRelated(
        ...
        val items = when (target.type) {
            TraktRelatedType.MOVIE -> {
                ...
                } ?: throw IllegalStateException(appContext.getString(com.foxtv.app.R.string.trakt_related_error_request_failed))
