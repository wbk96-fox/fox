...
import com.foxtv.app.core.trakt.traktBestBackdropUrl
import com.foxtv.app.core.trakt.traktBestLogoUrl
import com.foxtv.app.core.trakt.traktBestPosterUrl
import com.foxtv.app.data.remote.api.TraktApi
import com.foxtv.app.data.remote.dto.trakt.TraktCreateOrUpdateListRequestDto
import com.foxtv.app.data.remote.dto.trakt.TraktIdsDto
import com.foxtv.app.data.remote.dto.trakt.TraktListItemDto
import com.foxtv.app.data.remote.dto.trakt.TraktListItemsMutationRequestDto
import com.foxtv.app.data.remote.dto.trakt.TraktListItemsMutationResponseDto
import com.foxtv.app.data.remote.dto.trakt.TraktListMovieRequestItemDto
import com.foxtv.app.data.remote.dto.trakt.TraktListShowRequestItemDto
import com.foxtv.app.data.remote.dto.trakt.TraktListSummaryDto
import com.foxtv.app.data.remote.dto.trakt.TraktReorderListsRequestDto
...
class TraktLibraryService @Inject constructor(
    ...
    suspend fun createPersonalList(
        ...
        } ?: throw IllegalStateException(appContext.getString(com.foxtv.app.R.string.trakt_library_error_request_failed))

        if (!response.isSuccessful) {
            throw IllegalStateException(errorMessageForCode(response.code(), appContext.getString(com.foxtv.app.R.string.trakt_library_error_create_list_failed)))
        }
    ...
    suspend fun updatePersonalList(
        ...
        performOptimisticMutation(
            ...
            if (!response.isSuccessful) {
                throw IllegalStateException(errorMessageForCode(response.code(), appContext.getString(com.foxtv.app.R.string.trakt_library_error_update_list_failed)))
            }
        }
    }
    ...
    suspend fun deletePersonalList(listId: String) {
        performOptimisticMutation(
            ...
            if (!response.isSuccessful && response.code() != 204) {
                throw IllegalStateException(errorMessageForCode(response.code(), appContext.getString(com.foxtv.app.R.string.trakt_library_error_delete_list_failed)))
            }
        }
    }
    ...
    suspend fun reorderPersonalLists(orderedListIds: List<String>) {
        ...
        performOptimisticMutation(
            ...
            if (!response.isSuccessful) {
                throw IllegalStateException(errorMessageForCode(response.code(), appContext.getString(com.foxtv.app.R.string.trakt_library_error_reorder_lists_failed)))
            }
        }
    }
    ...
    private suspend fun fetchWatchlistEntries(): List<LibraryEntry> {
        val movies = fetchAllPages<TraktListItemDto> { page ->
            ...
            } ?: throw IllegalStateException(appContext.getString(com.foxtv.app.R.string.trakt_library_error_fetch_watchlist_movies))
        }
        ...
        val shows = fetchAllPages<TraktListItemDto> { page ->
            ...
            } ?: throw IllegalStateException(appContext.getString(com.foxtv.app.R.string.trakt_library_error_fetch_watchlist_shows))
        }
    ...
    private suspend fun fetchPersonalLists(): PersonalListFetchResult {
        ...
        } ?: throw IllegalStateException(appContext.getString(com.foxtv.app.R.string.trakt_library_error_fetch_personal_lists))

        if (!response.isSuccessful) {
            throw IllegalStateException("${appContext.getString(com.foxtv.app.R.string.trakt_library_error_fetch_personal_lists)} (${response.code()})")
        }
    ...
    private suspend fun fetchPersonalListItems(
        ...
        val items = fetchAllPages<TraktListItemDto> { page ->
            ...
            } ?: throw IllegalStateException(appContext.getString(com.foxtv.app.R.string.trakt_library_error_fetch_list_items))
        }
    ...
    private fun mapListTab(dto: TraktListSummaryDto): LibraryListTab? {
        ...
        return LibraryListTab(
            ...
            title = dto.name?.takeIf { it.isNotBlank() } ?: appContext.getString(com.foxtv.app.R.string.library_list_fallback_title),
    ...
    private suspend fun addToWatchlist(item: LibraryEntryInput) {
        ...
        if (!response.isSuccessful || !isSuccessfulAddResponse(response.body())) {
            throw IllegalStateException(errorMessageForCode(response.code(), appContext.getString(com.foxtv.app.R.string.trakt_library_error_add_watchlist_failed)))
        }
    }
    ...
    private suspend fun removeFromWatchlist(item: LibraryEntryInput) {
        ...
        if (!response.isSuccessful) {
            throw IllegalStateException(errorMessageForCode(response.code(), appContext.getString(com.foxtv.app.R.string.trakt_library_error_remove_watchlist_failed)))
        }
    }
    ...
    private suspend fun addToPersonalList(listId: String, item: LibraryEntryInput) {
        ...
        if (!response.isSuccessful || !isSuccessfulAddResponse(response.body())) {
            throw IllegalStateException(errorMessageForCode(response.code(), appContext.getString(com.foxtv.app.R.string.trakt_library_error_add_to_list_failed)))
        }
    }
    ...
    private suspend fun removeFromPersonalList(listId: String, item: LibraryEntryInput) {
        ...
        if (!response.isSuccessful) {
            throw IllegalStateException(errorMessageForCode(response.code(), appContext.getString(com.foxtv.app.R.string.trakt_library_error_remove_from_list_failed)))
        }
    }
    ...
    private fun buildMutationBody(item: LibraryEntryInput): TraktListItemsMutationRequestDto {
        ...
        if (!ids.hasAnyId()) {
            throw IllegalStateException(appContext.getString(com.foxtv.app.R.string.trakt_library_error_missing_compatible_ids))
        }
    ...
    private fun errorMessageForCode(code: Int, defaultMessage: String): String {
        return when (code) {
            401, 403 -> appContext.getString(com.foxtv.app.R.string.trakt_library_error_auth_expired)
            404 -> appContext.getString(com.foxtv.app.R.string.trakt_library_error_list_not_found)
            420 -> appContext.getString(com.foxtv.app.R.string.trakt_library_error_list_limit_reached)
    ...
    private suspend fun <T> fetchAllPages(
        ...
        while (true) {
            ...
            if (!response.isSuccessful) {
                throw IllegalStateException(appContext.getString(com.foxtv.app.R.string.trakt_library_error_paginated_fetch_failed, response.code()))
            }
