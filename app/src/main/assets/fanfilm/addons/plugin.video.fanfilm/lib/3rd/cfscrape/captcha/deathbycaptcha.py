        ...
        try:
            ...
            try:
                ...
                raise CaptchaTimeout(
                    "DeathByCaptcha: Captcha solve took to long and also failed reporting the job id {}.".format(
                        jobID
                    )
                )

            raise CaptchaTimeout(
                "DeathByCaptcha: Captcha solve took to long to execute job id {}, aborting.".format(
                    jobID
                )
            )
